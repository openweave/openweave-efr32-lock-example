...
private:
    ...
    static void HandleSubscriptionEngineEvent(void *                                  appState,
    ...
    static void HandleInboundSubscriptionEvent(void *                                   aAppState,
    ...
    nl::Weave::Profiles::DataManagement::SingleResourceSinkTraitCatalog::CatalogItem
                                                                        mServiceSinkCatalogStore[kSinkHandle_Max];
